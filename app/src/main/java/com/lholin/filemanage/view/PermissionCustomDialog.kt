package com.lholin.filemanage.view
...
import com.lholin.filemanage.R
import com.permissionx.guolindev.dialog.RationaleDialog

class PermissionCustomDialog(context: Context, val message: String, val permissions: List<String>) :
    RationaleDialog(context, R.style.ActionSheetDialogStyle) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.dialog_permission_cus)
